...
<div id="conteudo">
	<h2>Exercício #1</h2>
	<p>Este é o conteúdo do arquivo <em>home.ctp</em>. Neste arquivo, creio eu, encontra-se o conteúdo padrão da página inicial.</p>
	<p><a href="http://book.cakephp.org/2.0/en/core-libraries/global-constants-and-functions.html">Funções e constantes globais [__d(...)]</a></p>
	<p><?php echo __d('cake_dev', 'Release Notes for CakePHP %s.', Configure::version()); ?></p>
